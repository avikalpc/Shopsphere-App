...
function SingleProduct() {
  ...
  return (
    <div className='m-4'>
        <Link to="/" className='p-2 bg-[black] text-white font-bold rounded-md m-8 w-full hover:bg-pink-500'> &lt; Back</Link>
        <div className='flex flex-col justify-center p-5 text-left m-16 mt-0'>
          ...
          <h2 className='w-fit rounded-lg font-bold bg-[black] mr-2 mb-2 mt-2 p-1 flex justify-center items-center text-white'>
          ...
          <div className='flex justify-center align-baseline'>
            <button onClick={() => handleCart({id, ...product})} className='p-2 bg-[black] text-white font-bold rounded-md mt-4 pl-6 pr-6 w-fit hover:bg-black-500 flex justify-center'>Add to Cart</button>
          </div>
        </div>
    </div>
  )
