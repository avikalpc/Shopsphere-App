...
function Carts() {
  ...
  return (
    ...
    <div className='w-fit m-4 ml-9 flex justify-start'>
      <Link to="/" className='p-2 bg-[black] text-white font-bold rounded-md m-8 w-full hover:bg-black-500'> &lt; Home</Link>
    </div>
    <div className='bg-white p-7 rounded-md flex flex-col justify-around items-center w-full'>
      ...
      <button onClick={() => handleClear()} className='w-fit p-2 pl-6 pr-6 font-bold flex justify-around items-center bg-[black] text-white rounded-md mt-4 hover:bg-black-500'>Clear Cart</button>
    </div>
    </>
  )
}
